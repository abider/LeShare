          ...
          <div class="portlet-body form">
              ...
              <form role="form" class="form-horizontal" method="POST" action="{{url('admin/user/'.$user['id'])}}">
                  ...
                  <div class="form-body">
                      ...
                      <div class="form-group form-md-line-input">
                          <label class="col-md-2 control-label" for="mobile">{{trans('labels.user.mobile')}}</label>
                          <div class="col-md-8">
                              <input type="text" class="form-control" id="mobile" name="mobile" placeholder="{{trans('labels.user.mobile')}}" value="{{$user['mobile']}}">
                              <div class="form-control-focus"> </div>
                          </div>
                      </div>
